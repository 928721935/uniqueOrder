...
public class SnowflakeIdWorkerUtil {
    ...
    public static void setWorkerId(Integer machineId) {
        workerId = machineId;
    }
...
//    }
    ...
    public static SnowflakeIdWorkerUtil getInstance(){
        if (snowflakeIdWorkerUtil == null) {
            synchronized (SnowflakeIdWorkerUtil.class){
                if (snowflakeIdWorkerUtil == null) {
                    SnowflakeInitiator.SnowflakeVo snowflakeVo = SnowflakeInitiator.snowflakeVo;
                    snowflakeIdWorkerUtil = new SnowflakeIdWorkerUtil(snowflakeVo.getWorkerId(), snowflakeVo.getDataCenterId());
                }
            }
        }
